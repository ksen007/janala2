 ...
 *
 * @see tests.nanoxml.XMLParseException
 *
   ...
   implements Serializable
{
    ...
    * </DL>
    *
    * @see tests.nanoxml.XMLElement#XMLElement(java.util.Properties)
    * @see tests.nanoxml.XMLElement#XMLElement(boolean)
    * @see tests.nanoxml.XMLElement#XMLElement(java.util.Properties,boolean)
    */
   public XMLElement()
   {
    ...
    * </DL>
    *
    * @see tests.nanoxml.XMLElement#XMLElement()
    * @see tests.nanoxml.XMLElement#XMLElement(boolean)
    * @see tests.nanoxml.XMLElement#XMLElement(java.util.Properties,boolean)
    */
    ...
    * @exception tests.nanoxml.XMLParseException
    ...
    *
    * @see tests.nanoxml.XMLElement#decodeString
    *
    * @exception tests.nanoxml.XMLParseException
    *    if an error occured while parsing the array
    */
    ...
    *         input[offset] in { '/', '>' }
    *
    * @see tests.nanoxml.XMLElement#scanOneAttribute
    *
    * @exception tests.nanoxml.XMLParseException
    *    if an error occured while parsing the array
    */
    ...
    *
    * @see tests.nanoxml.XMLElement#parseCharArray
    *
    * @exception tests.nanoxml.XMLParseException
    *    if an error occured while parsing the array
    */
      ...
      throws XMLParseException
   {
      ...
      CATG.equivalent("test1", "loc1", offset);
      return offset;
   }
    ...
    *
    * @see tests.nanoxml.XMLElement#scanIdentifier
    *
    * @exception tests.nanoxml.XMLParseException
    *    if an error occured while parsing the array
    */
      ...
      throws XMLParseException
   {
      ...
      offset = offset + this.tagName.length();
      CATG.equivalent("test1", "loc3", offset);
      return offset;
   }
      ...
      throws XMLParseException
   {
      ...
      CATG.equivalent("test1", "loc2", offset);
      return offset;
   }
