...
public class CATG {
    public static int readInt(int x) {
        ...
        Main.MakeSymbolic(y);
        Main.Assume(y <= Integer.MAX_VALUE);
        Main.Assume(y >= Integer.MIN_VALUE);
        return y;
    }
    ...
    public static long readLong(long x) {
        ...
        Main.MakeSymbolic(y);
        Main.Assume(y <= Long.MAX_VALUE);
        Main.Assume(y >= Long.MIN_VALUE);
        return y;
    }
    ...
    public static char readChar(char x) {
        ...
        Main.MakeSymbolic(y);
        Main.Assume(y <= Character.MAX_VALUE);
        Main.Assume(y >= Character.MIN_VALUE);
        return y;
    }
    ...
    public static byte readByte(byte x) {
        ...
        Main.MakeSymbolic(y);
        Main.Assume(y <= Byte.MAX_VALUE);
        Main.Assume(y >= Byte.MIN_VALUE);
        return y;
    }
    ...
    public static short readShort(short x) {
        ...
        Main.MakeSymbolic(y);
        Main.Assume(y <= Short.MAX_VALUE);
        Main.Assume(y >= Short.MIN_VALUE);
        return y;
    }
